...
public class Order {
    ...
    /**
     * Constructor for creating a new order (without an order number).
     * The order number will be generated by the application layer.
     */
    public Order(String customerId, LocalDateTime orderDate, List<OrderItem> items, OrderStatus status) {
        if (customerId == null || customerId.trim().isEmpty()) {
            throw new IllegalArgumentException("Customer ID cannot be null or empty");
        }
        if (orderDate == null) {
        ...
        // For new orders, orderNumber is null until generated
        ...
        // No domain event is added here since the order is not yet created
        // Domain events will be added after the order number is generated
    }
